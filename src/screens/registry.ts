...
export const SCREENS: ScreenDef[] = [
  ...
  // Issue #55's confirmation beat (id '4b', /poll/sent) is retired per issue #104: sending now drops
  // straight into live voting, confirmed by a toast there instead of an intermediate screen.
  { id: '5', path: '/poll', title: 'Poll voting (live)', designRef: 'DESIGN.md §Screens 5', note: 'Group votes; counts update live. Shows a "poll sent" toast on arrival from Create poll (issue #104).' },
